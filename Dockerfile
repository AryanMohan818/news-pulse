...
# Install Python machine learning dependencies
...
CMD python3 -u scraper/app.py & cd backend && PORT=3001 DB_PATH=/app/data/news_pulse.db SCRAPER_URL=http://127.0.0.1:5000 node index.js
